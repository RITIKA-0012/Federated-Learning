...
def predict_sample(input_dict):
    ...
    for feat in features:
        ...
        if feat in FEATURE_ENCODINGS and isinstance(value, str):
            value = FEATURE_ENCODINGS[feat][value]
...
def live_prediction():
    ...
    feature_hints = {
        "cp": "typical angina, atypical angina, non-anginal, or asymptomatic",
        "thalch": "Maximum heart rate achieved (bpm, e.g. 71 - 202)",
        "ca": "Number of major vessels (0-3) colored by fluoroscopy",
        "oldpeak": "ST depression induced by exercise (e.g. 0.0 - 6.2)",
    ...
    for feat in features:
        ...
        try:
            ...
            if not val_str:
                ...
                patient_data[feat] = FEATURE_ENCODINGS.get(feat, {}).get(val_str, val_str)
