...
csv_path = os.path.join(base_dir, "data", "heart_disease_1.csv")
...
def train_model():
    ...
    # 3. Align Target
    # In heart_disease_1.csv, Status 0 = Disease (High Risk), Status 1 = No Disease (Low Risk)
    # Align target so: 1 = High Risk / Disease Detected, 0 = Low Risk / No Disease Detected
    if "Status" in data.columns:
        ...
        data["target"] = data[data.columns[-1]]
